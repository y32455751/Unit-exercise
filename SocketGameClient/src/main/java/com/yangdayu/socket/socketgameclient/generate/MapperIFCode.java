...
public class MapperIFCode {
	...
	public static void main(String[] args) {
		...
		buffer.append("package com.yangdayu.socket.socketgameclient.mapper;\n\n");
		...
		buffer.append("public interface "+classname+"Mapper {\n\n");
		buffer.append("\tvoid add"+classname+"("+classname+" "+entityname+");\n\n");
		buffer.append("\tint delete"+classname+"(String objuid);\n\n");
		buffer.append("\tint update"+classname+"("+classname+" "+entityname+");\n\n");
