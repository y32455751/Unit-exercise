 ...
 * activemq 消息接收端
 */
public class JMSPersistenceTopicRevicer {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            connection.setClientID("myTestClientId");
            connection.start();
            ...
            // 创建一个消息接收人，接收制定队列的消息
            MessageConsumer consumer = session.createDurableSubscriber(topic,"myTestClientId");
